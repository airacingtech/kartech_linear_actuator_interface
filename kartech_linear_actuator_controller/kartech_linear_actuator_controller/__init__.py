...
from kartech_linear_actuator_interface_msgs.msg import BrakeControl, BrakePositionReport, KdFreqDeadbandRequest
...
class KartechLinearActuatorController(Node):
    ...
    def __init__(self):
        ...
        self.kpa_to_minch_lookup = InterpolatedUnivariateSpline(BRAKE_PRESSURE_KPA, BRAKE_POSITIONS_MINCH)
    ...
    def brake_control_callback(self, brake_request):
        ...
        fdfw_position = self.kpa_to_minch_lookup(brake_req_kpa) + 500.0 + 300.0
        fdbk_position = 0.0
        # if self.brake_pressure_kpa is not None:
        #     fdbk_position = (brake_req_kpa - self.brake_pressure_kpa) * K
        # else:
        #     fdbk_position = 0.0
        position = fdfw_position + fdbk_position
        print(self.brake_pressure_kpa)
